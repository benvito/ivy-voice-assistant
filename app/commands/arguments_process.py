...
from config.constants import ADD_EACH, CONCAT, PICK_FIRST_MATCH, PICK_LAST_MATCH, PICK_LAST_IN_FIRST_MATCH, PICK_FIRST_IN_FIRST_MATCH, PICK_FIRST_IN_LAST_MATCH, PICK_LAST_IN_LAST_MATCH, CMD_ARGS, REGEX_ON, PREFIX, ARGS_SEP, POSTFIX
