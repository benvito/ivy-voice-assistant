...
from config.config import IMG_MACRO,PRESS,IMG,POSITION,DEFINE,WAIT,AIM,CLICK,SIZE,CENTER,X,Y,POS,MOVE,STRAIGHT,WATCH,TRIGGER,LEFT_TOP,RIGHT_TOP,LEFT_BOTTOM,RIGHT_BOTTOM,LEFT_CENTER,RIGHT_CENTER
